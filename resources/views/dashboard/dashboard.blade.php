    ...
    <section class="bg-gray-50 py-6 sm:py-8 md:py-10">
        <div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
            ...
            @php
                ...
                $ketentuans = App\Models\Ketentuan::whereNotNull('panduan')->whereNotNull('file_panduan')->get();
                    ...
                    <div class="p-3 sm:p-4 md:p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
                            @foreach ($kpTemplates as $template)
                                <!-- Template Item -->
                                <a href="{{ asset('storage/' . $template->file_panduan) }}" target="_blank"
                                    class="bg-gray-50 rounded-lg p-3 sm:p-4 border border-gray-200 hover:bg-gray-100 transition flex flex-col items-center text-center group">
                                    <div class="text-blue-600 mb-2 sm:mb-3">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-8 w-8 sm:h-10 sm:w-10 group-hover:scale-110 transition-transform"
                                    ...
                                    <h4 class="font-semibold text-gray-800 mb-2 text-sm sm:text-base">
                                        {{ $template->panduan }}</h4>
                                    <span
                                        class="text-blue-600 hover:text-blue-800 flex items-center justify-center text-xs sm:text-sm">
            ...
            @if ($ketentuans->count() == 0)
                <div class="bg-white p-4 sm:p-6 rounded-lg shadow-lg text-center">
                    <p class="text-gray-600 text-sm sm:text-base">Belum ada template yang tersedia. Silakan cek kembali
                        nanti.</p>
                </div>
            @endif
        </div>
